...
namespace SpaceInvaders
{
    class TimedCharacterFactory
    {
        ...
        static public void Install(Sprite spriteToPrint, string pMessage, float deltaTimeToTrigger, float delayTime, float xPos, float yPos, float red, float green, float blue)
        {
            TimedCharacterFactory pInstance = TimedCharacterFactory.privInstance();
            // future use
            ...
            spriteToPrint.x = xPos;
            spriteToPrint.y = yPos;
